...
job="preco_minimo_tipo_doc_venda"
...
nome_arquivo="tabela_zptl_ZV12_*.zip"
...
source_object_in_bucket_load="Dados_cimed/"+pasta
...
def read_file_xml():
    ...
    print(nome_bucket+destino_arquivos_xml+"*.xml")
